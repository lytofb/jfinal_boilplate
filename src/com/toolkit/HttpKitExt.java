...
public class HttpKitExt {
	...
	private static final TrustAnyHostnameVerifier trustAnyHostnameVerifier = new HttpKitExt().new TrustAnyHostnameVerifier();
	
	private static SSLSocketFactory initSSLSocketFactory() {
		try {
			TrustManager[] tm = {new HttpKitExt().new TrustAnyTrustManager() };  
	...
	public static String post(String url, Map<String, String> queryParas, String data,Integer timeout) {
		return post(url, queryParas, data, null,timeout);
	}
	
	public static String post(String url, Map<String, String> queryParas, String data) {
		return post(url, queryParas, data, null,null);
	}
	
	public static String post(String url, String data, Map<String, String> headers) {
		return post(url, null, data, headers,null);
	}
