...
import com.nnit.pvc.authentication.UserAuthenticationInterface;
import com.nnit.pvc.authentication.UserAuthenticationSFDB;
...
//        String interfacename = getInterfaceNameByDbTarget(dbtarget);
        ...
        Class clazz = null;
        try {
			clazz = Class.forName("com.nnit.pvc.authentication."+interfacename);
...
//        }
    ...
    private String getInterfaceNameByDbTarget(String username) {
    	String distributeDbName = PropKit.use("config.properties").get("distributeDbName");
    	String distributeTableName = PropKit.use("config.properties").get("distributeTableName");
    	Record r= null;
